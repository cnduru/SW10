...
\subsection*{Results}
\input{documents/experiment/results}
\subsubsection{Base}
\input{documents/experiment/base}
\subsubsection{Code Duplication}
\input{documents/experiment/codedup}
\subsubsection{Call Graph Integrity}
\input{documents/experiment/cgi}
\subsubsection{Call Flow Integrity}
\input{documents/experiment/cfi}
\subsubsection{Call Flow Integrity 2}
\input{documents/experiment/cfi2}
% % % % %

\section{Invoke}
\input{documents/experiment/setupVirtual}
\subsection*{Results}
\input{documents/experiment/resultsVirtual}
\subsubsection{Base}
\input{documents/experiment/baseVirtual}
\subsubsection{Call Graph Integrity}
\input{documents/experiment/cgiVirtual}
\subsubsection{Call Flow Integrity}
\input{documents/experiment/cfiVirtual}
\subsection{Summary}
\input{documents/experiment/summary}
