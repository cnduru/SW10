...
Under normal execution there is to difference between the two approaches, but then introducing fault models as PC\_Fault and INST\_Fault it is possible to change the behaviour enough to let a operand stack pointer point to out of the operand stack.
