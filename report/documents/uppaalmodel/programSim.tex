...
\subsubsection{Local Variables and the Heap}
\ch{merge with operand stack description?}
\ch{find some place to put these two lines and remove subsubsection}
Local variables and the heap are both represented as arrays in the UPPAAL model.
